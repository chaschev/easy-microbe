 ...
 *   <li>Annotate any fields with {@literal @}{@link com.google.caliper.Param} that should have parameter values
 *       injected (see {@literal @}{@link com.google.caliper.Param} for more details)
 *   <li>Optionally use {@link com.google.caliper.BeforeExperiment} and {@link com.google.caliper.AfterExperiment} on setup and teardown
 *       methods
 * </ol>
 *
 ...
 * two {@link com.google.caliper.Param Params} ({@code feature} and {@code size}). For each experiment performed by
